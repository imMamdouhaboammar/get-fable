---
name: get-fable
description: Claude-facing adapter to the canonical get-fable workflow for evidence, planning, bounded execution, verification, and recovery.
---

# get-fable Claude adapter
...
Apply the same routing order when direct skill delegation is unavailable:
