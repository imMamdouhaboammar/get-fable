...
### Model Descriptions
- **Claude Opus 5** — The pinnacle frontier reasoning model for ultra-complex engineering, multi-repository architecture, and autonomous system governance. Full 1M context with 128K output window.
