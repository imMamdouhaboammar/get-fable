...
- **Target:** `http://127.0.0.1:56198`
- **Scan Profile:** `orchestrated`
- **Execution Period:** 2026-09-15T06:14:07.976Z to 2026-09-15T06:14:09.170Z
...
- **Cryptographic Attestation Hash:** `c6f8e3427dcfe7af6d204b7b676fa07c452701c8f34532f9eb8faa1f1e2a6145`
...
- **Vulnerable Target:** `http://127.0.0.1:56198`
...
- **Vulnerable Target:** `http://127.0.0.1:56198/.env`
...
**Reproduction Proof-of-Concept:**
```bash
curl -i -s "http://127.0.0.1:56198/.env"
```
