...
- **Target:** `http://127.0.0.1:54879`
- **Scan Profile:** `orchestrated`
- **Execution Period:** 2026-09-13T09:00:05.326Z to 2026-09-13T09:00:06.502Z
...
- **Cryptographic Attestation Hash:** `57fde9407eb6444804ab15fd1e9fc52be634ee5b8fe630b6fd38e137fa895437`
...
- **Vulnerable Target:** `http://127.0.0.1:54879`
...
- **Vulnerable Target:** `http://127.0.0.1:54879/.env`
...
**Reproduction Proof-of-Concept:**
```bash
curl -i -s "http://127.0.0.1:54879/.env"
```
