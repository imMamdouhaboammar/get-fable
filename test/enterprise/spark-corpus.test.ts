...
import { runEnterpriseSparkBenchmark } from '../../src/core/eval-runner.ts';

describe('enterprise Spark corpus', () => {
  test('executes checked Spark categories without consulting frozen holdouts', () => {
    const result = runEnterpriseSparkBenchmark();
